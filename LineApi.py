...
class LINE:
  ...
  def __init__(self):
    ...
    self._headers = {'X-Line-Application': 'DESKTOPMAC\t10.10.2-YOSEMITE-x64\tMAC 4.5.0', 'X-Line-Access': 'En0Kl8eQg3MYwWKB8DEc.skwgztg4SuqUu1exNpTcpa.vSCA046duToTEnhEGM8gpCCyFrPbRMMPOQlNu+orAa4=', 'User-Agent': 'Line/8.1.1 iPad4,1 9.0.2'}
 ...
 #       return self.Talk.client.call.getGroupCall(ChatMid)
  ...
  def loginResult(self, callback=None):
    if callback is None:
      ...
      print("=======LINE MIN===============")
      print("        Line: socool290         ")
      print("==============================")
      print("           Install Siri V10            ")
      print("===============================")
      print("           Install SELF BOT        ")
      print("================================")
      print("            Buy BOT 300 baht    ")
      print("================================")
